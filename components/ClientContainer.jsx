...
function ClientContainer() {
  ...
  const services = [
    ...
    { name: "Single Page Websites", icon: Globe },
    { name: "Landing Pages", icon: PlaneLanding },
    { name: "Online Courses", icon: GraduationCap },
    { name: "Blogs", icon: FileText },
    { name: "Membership Sites", icon: Users },
    { name: "Rental E-commerce", icon: Store },
    { name: "Custom E-commerce", icon: ShoppingCart },
    { name: "Online/Digital Marketing", icon: BarChart3 },
    { name: "Social Media Management", icon: Share2 },
    { name: "Branding", icon: Sparkles },
    { name: "Graphic Design", icon: Paintbrush },
    { name: "Marketing Strategies", icon: LineChart },
  ];
    ...
    <>
      ...
      <div className="sticky top-0 w-full h-screen bg-black z-10">
        ...
        <div className="absolute inset-0 w-full h-full">
          <Image
            ...
            fill
            className="object-cover p-6 opacity-50"
            priority
          />
          {/* Dark overlay with matte finish */}
          <div className="absolute inset-0 bg-black/50 backdrop-filter backdrop-blur-sm" style={{ mixBlendMode: 'multiply' }} />
        </div>
        ...
        >
          ...
          <svg className="absolute -bottom-16 -left-8 w-24 h-24 text-yellow-300 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M90,30 Q50,90 30,70 Q40,60 20,50 L10,60 L5,40 L25,35 L15,45 Q35,55 25,65 Q45,85 85,25" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>
        ...
        >
          ...
          {/* Arrow SVG pointing to header */}
          <svg className="absolute -top-16 -right-8 w-24 h-24 text-blue-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M10,70 Q50,10 70,30 Q60,40 80,50 L90,40 L95,60 L75,65 L85,55 Q65,45 75,35 Q55,15 15,75" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>
        ...
        <div className="absolute w-full h-full flex flex-col top-0 z-10 flex items-center justify-center px-4 pt-20 overflow-hidden">
          <h1 className={`font-humane font-bold tracking-wide text-white/60 text-center text-7xl sm:text-8xl lg:text-9xl leading-tight tracking-wide transition-all duration-1000 ${titleVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-left'>WE</span> 
            <span className='inline-block animate-slide-in-right'>ARE NOT</span> 
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-left'>JUST</span><br/> 
            <span className='inline-block animate-slide-in-bottom'>ANOTHER WEB & DEV</span><br /> 
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-top'>COMPANY</span>
          </h1>
        </div>
      </div>
      ...
      <div id="third-section" className="relative w-full h-[80vh] bg-black z-30">
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          />
          {/* Dark overlay with matte finish */}
          <div className="absolute inset-0 bg-black/60 backdrop-filter backdrop-blur-sm" style={{ mixBlendMode: 'multiply' }} />
        </div>
        ...
        >
          ...
          {/* Arrow SVG pointing to header */}
          <svg className="absolute -translate-x-8 -bottom-10 right-0 w-24 h-24 text-green-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M10,30 Q50,90 70,70 Q60,60 80,50 L90,60 L95,40 L75,35 L85,45 Q65,55 75,65 Q55,85 15,25" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>
        ...
        >
          ...
          {/* Arrow SVG pointing to header */}
          <svg className="absolute -top-16 -left-8 w-24 h-24 text-purple-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M90,70 Q50,10 30,30 Q40,40 20,50 L10,40 L5,60 L25,65 L15,55 Q35,45 25,35 Q45,15 85,75" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>

        {/* Heading container */}
        <div className="absolute w-full h-full flex flex-col top-0 z-10 flex items-center justify-center px-4 pt-20 overflow-hidden">
          <h1 className={`font-humane font-bold tracking-wide text-white/60 text-center text-7xl sm:text-8xl lg:text-9xl leading-tight tracking-wide transition-all duration-1000 ${thirdSectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-left'>OUR</span> 
            <span className='inline-block animate-slide-in-right'>LATEST</span> 
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-bottom'>SOLUTIONS</span>
          </h1>
        </div>
      </div>
      ...
      <div id="fourth-section" className="relative w-full h-[140vh] bg-black z-40 overflow-hidden">
        ...
        <div className={`absolute rounded-2xl ovrtflow-hidden max-h-[440px] right-0 top-1/3 -translate-y-1/2 w-2/3 h-3/5 z-10 overflow-hidden transition-all duration-1000 ${fourthSectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
        ...
        <div className={`absolute left-10 rotate-5 sm:left-20 md:left-32 top-1/3 -translate-y-1/2 z-20 w-[300px] sm:w-[400px] bg-white/10 backdrop-filter backdrop-blur-md rounded-xl p-8 shadow-2xl border border-white/20 transform hover:scale-105 transition-all duration-1000 ${fourthSectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          <div className="flex flex-col items-start">
            ...
            <h3 className="text-white text-xl sm:text-2xl font-medium mb-4 animate-slide-in-left">E-commerce Platform</h3>
        ...
        <div className={`absolute bottom-20 left-0 right-0 z-30 px-8 sm:px-16 md:px-24 transition-all duration-1000 ${fourthSectionVisible ? 'opacity-100 translate-y-4' : 'opacity-0 translate-y-20'}`}>
          <div className="max-w-4xl mx-auto p-6 sm:p-8">
            ...
            <p className="text-white/80 text-base sm:text-lg leading-relaxed font-light animate-slide-in-bottom">
              ...
              <span className="text-primary"> ecommerce solution service</span> is not only to charge for services but to also add 
        ...
        {/* Decorative elements */}
        <div className={`absolute bottom-10 left-10 z-10 transition-all duration-1000 ${fourthSectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <div id="fifth-section"  className="relative w-full h-[160vh] bg-black z-50 overflow-hidden">
        ...
        >
          ...
          {/* Arrow SVG pointing to header */}
          <svg className="absolute top-6 -left-20 w-24 h-24 text-purple-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M90,70 Q50,10 30,30 Q40,40 20,50 L10,40 L5,60 L25,65 L15,55 Q35,45 25,35 Q45,15 85,75" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>

        {/* Rent a Store image with skewed appearance */}
        <div className={`absolute  max-h-[450px] left-0 top-1/3  -translate-y-1/2 w-2/3 h-3/5 z-10 transition-all duration-1000 ${fifthSectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          {/* Container with perspective for skew effect */}
        ...
        <div className={`absolute right-10 -rotate-5 sm:right-20 md:right-32 top-1/3 -translate-y-1/2 z-20 w-[300px] sm:w-[400px]  rounded-xl  shadow-2xl  transform hover:scale-105 transition-all duration-1000 ${fifthSectionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
          <Image
        ...
        {/* Description paragraph below the image and card */}
        <div className={`absolute bottom-20 left-0 right-0 z-30 px-8 sm:px-16 md:px-24 transition-all duration-1000 ${fifthSectionVisible ? 'opacity-100 translate-y-4' : 'opacity-0 translate-y-20'}`}>
          <div className="max-w-4xl mx-auto p-6 sm:p-8">
            ...
            <p className="text-white/80 text-base sm:text-lg leading-relaxed font-light animate-slide-in-bottom">
              For as <span className="text-white font-medium">Low</span> as <span className="text-primary "> 1k </span> a <span className="text-primary font-medium">month</span>, our customers can be able to get <span className="text-white font-medium">their own</span> <span className="text-primary ">.co.ke</span> domainn name and an <span className="text-primary font-medium">E-commerce Store</span> to star selling on the go.
              Our sores come with <span className="text-primary font-medium">Online M-pesa Payment</span> support, <span className="text-primary font-medium">Order Management</span> and have partnered with all the major delivery services to provide smooth <span className="text-primary font-medium">Deliveries</span> across Kenya.
            </p>
          </div>
        </div>

        {/* Decorative elements */}
        <div className={`absolute bottom-10 right-10 z-10 transition-all duration-1000 ${fifthSectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="flex space-x-3">
            <div className="w-5 h-1 bg-white/30 rounded-full"></div>
            <div className="w-10 h-1 bg-white/50 rounded-full"></div>
            <div className="w-20 h-1 bg-primary rounded-full"></div>
      ...
      <div id="services-section" className="relative  w-full min-h-screen bg-black z-45 overflow-hidden py-20">
        ...
        >
          ...
          <svg className="absolute -bottom-16 -left-8 w-24 h-24 text-green-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M90,30 Q50,90 30,70 Q40,60 20,50 L10,60 L5,40 L25,35 L15,45 Q35,55 25,65 Q45,85 85,25" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>

        {/* Section heading */}
        <div className={`relative z-20 text-center mb-16 transition-all duration-1000 ${servicesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          <h2 className="font-humane text-white text-7xl sm:text-8xl lg:text-9xl mb-4">OUR <span className="text-primary">SERVICES</span></h2>
      ...
      <div id="sixth-section" className="relative w-full h-screen bg-black z-50 overflow-hidden">
        ...
        <div 
          ...
          style={{ fontFamily: 'Caveat, cursive' }}
        >
          <p className="text-yellow-200 text-2xl text-center transform -rotate-3">we don't just create sites and apps</p>
          {/* Arrow SVG pointing to header */}
          <svg className="absolute -bottom-16 -right-8 w-24 h-24 text-yellow-200 fill-current animate-bounce-slow" viewBox="0 0 100 100">
            <path d="M10,30 Q50,90 70,70 Q60,60 80,50 L90,60 L95,40 L75,35 L85,45 Q65,55 75,65 Q55,85 15,25" stroke="currentColor" strokeWidth="2" fill="none" />
          </svg>
        </div>

        {/* Heading container - centered in the section */}
        <div className={`absolute w-full h-full flex items-center justify-center px-4 z-20 transition-all duration-1000 ${sixthSectionScrolled ? 'opacity-30 scale-95' : 'opacity-100 scale-100'}`}>
          <h1 className={`font-humane font-bold tracking-wide text-white/60 text-center text-7xl sm:text-8xl lg:text-9xl leading-tight tracking-wide transition-all duration-1000 ${sixthSectionVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-left'>WHY</span> 
            <span className='inline-block animate-slide-in-right'>WE ARE</span> 
            <span className='text-8xl sm:text-9xl lg:text-[9.5rem] text-white mr-2 inline-block animate-slide-in-bottom'>THE BEST</span>
          </h1>
        </div>

        {/* "Read more" indicator that appears after title is fully visible */}
        <div className={`absolute bottom-10 left-0 right-0 flex justify-center z-30 transition-all duration-500 ${sixthSectionTitleFullyVisible && !sixthSectionScrolled ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <div className={`absolute inset-0 flex items-center justify-center z-30 px-8 sm:px-16 md:px-24 transition-all duration-1000 ease-in-out ${sixthSectionVisible ? 'opacity-100' : 'opacity-0'} ${sixthSectionScrolled ? 'translate-y-0' : 'translate-y-full'}`}>
          <div className="max-w-4xl mx-auto bg-black/70 backdrop-filter backdrop-blur-md p-8 sm:p-10 rounded-xl border border-white/10 shadow-2xl">
            ...
            <p className="text-white/90 text-xl sm:text-2xl leading-relaxed font-light text-center">
              We <span className="text-primary font-medium">bring your vision to life</span>. With leading industry expertise, we make your <span className="text-white font-medium">dream come true</span>. Our <span className="text-primary font-medium">solutions</span> explain our work better. We build to suit <span className="text-white font-medium">you and your customers' needs</span> and make your business grow. <span className="text-primary font-medium text-2xl sm:text-3xl">Try us today</span>.
            </p>
          </div>
        </div>
        ...
        <div className="absolute inset-0 z-10 overflow-hidden pointer-events-none">
          {/* Code icon */}
          <div className={`absolute top-1/4 right-1/4 text-white/20 animate-float transition-opacity duration-1000 ${sixthSectionVisible ? 'opacity-20' : 'opacity-0'}`}>
          ...
          {/* Design icon */}
          <div className={`absolute bottom-1/4 left-1/4 text-white/20 animate-float-delay transition-opacity duration-1000 ${sixthSectionVisible ? 'opacity-20' : 'opacity-0'}`}>
            <svg className="w-24 h-24 md:w-32 md:h-32" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* Mobile icon */}
          <div className={`absolute top-1/3 left-1/6 text-white/20 animate-float-reverse transition-opacity duration-1000 ${sixthSectionVisible ? 'opacity-20' : 'opacity-0'}`}>
