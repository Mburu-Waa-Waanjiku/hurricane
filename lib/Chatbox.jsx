...
export default function Chatbox() {
  ...
  return (
    <div>
      {openChat &&
        <div className="fixed z-20 chatboxsize overflow-hidden bg-white m-0 xsm:m-8 bottom-0 right-0">
          ...
          <Link href="https://wa.me/254704065652?text=Hello%20Hurricane,%20I'm%20John.I%20...." >
